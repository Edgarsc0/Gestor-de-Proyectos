      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        >
          <motion.div
            ...
            className="w-16 h-16 bg-gradient-to-br from-brand-500 to-violet-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-brand-500/40"
          >
        ...
        >
          ...
          >
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-8">
              Gestiona proyectos, tareas y el avance de cada<br />miembro de tu equipo.
            </p>
          </motion.div>
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5
                       bg-white text-slate-800 font-semibold rounded-2xl text-sm
